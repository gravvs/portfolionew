    ...
    return (
        ...
        <div className={`hamburger${show}`} >
            ...
            <div className="hamburger__subwrapper">
                <div className="hamburger__items"><img src={portfolio} alt="portfolio"/></div>
                <div className="hamburger__items"><img src={tech} alt="categories"/></div>
                <div className="hamburger__items"><img src={cpu} alt="technology"/></div>
                <div className="hamburger__items"><img src={contact} alt="contact me"/></div>
            </div>
        </div>
}
        </>
